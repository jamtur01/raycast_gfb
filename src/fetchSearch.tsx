...
import { SearchResponse, SearchResultItem, SearchResultSection } from "./types/searchTypes";
...
function favoriteAccessories(type: "team" | "player", id: string) {
  return [
    {
      tooltip: "Favorite",
      icon: {
      ...
      target: `raycast://favorite/${type}/${id}`,
    },
  ];
}

export function fetchSearch(searchText: string) {
